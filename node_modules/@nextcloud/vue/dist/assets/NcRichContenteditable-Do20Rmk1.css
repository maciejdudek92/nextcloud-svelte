...
* Ensure proper alignment of the vue material icons
*/
.material-design-icon[data-v-426785d7] {
  display: flex;
  align-self: center;
  justify-self: center;
  align-items: center;
...
.rich-contenteditable[data-v-426785d7] {
...
.rich-contenteditable__label[data-v-426785d7] {
  position: absolute;
  margin-inline: 14px;
...
.rich-contenteditable__input:focus + .rich-contenteditable__label[data-v-426785d7], .rich-contenteditable__input:not(.rich-contenteditable__input--empty) + .rich-contenteditable__label[data-v-426785d7] {
...
.rich-contenteditable__input[data-v-426785d7] {
  overflow-y: auto;
  width: auto;
  margin: 0;
...
.rich-contenteditable__input--has-label[data-v-426785d7] {
  margin-top: 10px;
}
.rich-contenteditable__input--empty[data-v-426785d7]:focus:before, .rich-contenteditable__input--empty[data-v-426785d7]:not(.rich-contenteditable__input--has-label):before {
...
.rich-contenteditable__input[contenteditable=false][data-v-426785d7]:not(.rich-contenteditable__input--disabled) {
  cursor: default;
  background-color: transparent;
  color: var(--color-main-text);
...
.rich-contenteditable__input--multiline[data-v-426785d7] {
  min-height: calc(var(--default-clickable-area) * 3);
  max-height: none;
}
.rich-contenteditable__input--disabled[data-v-426785d7] {
  opacity: 0.5;
  color: var(--color-text-maxcontrast);
...
.rich-contenteditable__input--overflow[data-v-426785d7], .rich-contenteditable__input--overflow[data-v-426785d7]:hover {
...
._tribute-container_aTO5r, ._tribute-container_aTO5r * {
  box-sizing: border-box;
}
._tribute-container_aTO5r ul {
  display: flex;
  flex-direction: column;
  gap: var(--default-grid-baseline);
}
._tribute-container_aTO5r ._tribute-container__item_EHZ07 {
  color: var(--color-text-maxcontrast);
  border-radius: var(--border-radius-small);
  padding: var(--default-grid-baseline);
  cursor: pointer;
...
._tribute-container_aTO5r ._tribute-container__item_EHZ07.highlight {
  color: var(--color-main-text);
  background: var(--color-background-hover);
}
._tribute-container_aTO5r ._tribute-container__item_EHZ07.highlight, ._tribute-container_aTO5r ._tribute-container__item_EHZ07.highlight * {
  cursor: pointer;
}
._tribute-container_aTO5r._tribute-container--focus-visible_GHsDW .highlight._tribute-container__item_EHZ07 {
  outline: 2px solid var(--color-main-text) !important;
}
._tribute-container-autocomplete_YNk1h {
  min-width: 250px;
  max-width: 300px;
  max-height: calc((var(--default-clickable-area) + 3 * var(--default-grid-baseline)) * 4.5 - 1.5 * var(--default-grid-baseline));
}
._tribute-container-emoji_jWgZX,
._tribute-container-link_1b7mc {
  min-width: 200px;
  max-width: 200px;
  max-height: calc((24px + 3 * var(--default-grid-baseline)) * 5.5 - 1.5 * var(--default-grid-baseline));
}
._tribute-container-emoji_jWgZX ._tribute-item_p5sRT,
._tribute-container-link_1b7mc ._tribute-item_p5sRT {
  white-space: nowrap;
  overflow: hidden;
  text-overflow: ellipsis;
}
...
._tribute-container-link_1b7mc ._tribute-item__title_VPcy9 {
  white-space: nowrap;
  overflow: hidden;
  text-overflow: ellipsis;
}
._tribute-container-link_1b7mc ._tribute-item__icon_aTxCU {
  margin: auto 0;
  width: 20px;
  height: 20px;
  object-fit: contain;
